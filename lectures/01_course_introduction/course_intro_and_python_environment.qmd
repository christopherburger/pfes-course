...
Having a computer solve a problem requires the creation of a set of instructions, a **program**. A **program** is a sequence of instructions that specifies how to perform a computation.
