...
A line plot is good for showing tends over time, distance, area, etc.
...
There are many more options than what is listed here that can be found in the official documentation.
